namespace Dempbot4
{
    ...
    public partial class App : Application
    {
        ...
        private static IServiceProvider ConfigureServices()
        {
            ...
            LibSettings.DataFolder = DataFolder;

            var services = new ServiceCollection();
            var dataRig = new DataAquisitionRig();
            services.AddSingleton(typeof(IDataRig), dataRig);
            services.AddSingleton<IExperiment, Experiment>();
            services.AddSingleton<ElectronicsProgram>();
            services.AddSingleton<PythonScripting>();
            services.AddSingleton<LuaScripting>();
    ...
    cli.Settings.HttpClientFactory = new UntrustedCertClientFactory());
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            LibSettings.DataRig = (IDataRig)Services.GetRequiredService(typeof(IDataRig));
