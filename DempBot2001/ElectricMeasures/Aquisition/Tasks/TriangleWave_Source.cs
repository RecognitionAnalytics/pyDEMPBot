...
{
    public class TriangleWave_Source : DataAquisionTasks
    {
        ...
        public TriangleWave_Source(string taskName, List<ChannelFunctionEnum> channelFilters,
            ...
            base(taskName, channelFilters,   logData, logFile)
        {
            ...
            FunctionGenerator = new BasicFunctionGenerator(BasicFunctionGeneratorSignal.Triangle);
